...
# TODO (cg 2026/02/06 13:55): this file, once complete, will be something that I
# turn into a family of tests.
...
@show isapprox(kv[1], kernel.(xgrid, Ref(test_params)); rtol=1e-10) # true
...
@show test_grads == warp_grads # true 
...
@show maximum(norm.(test_grads .- kernel_grads)) < 1e-8
